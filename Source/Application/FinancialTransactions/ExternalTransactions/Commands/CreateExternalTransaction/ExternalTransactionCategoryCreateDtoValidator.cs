...
{
    public class ExternalTransactionCategoryCreateDtoValidator : AbstractValidator<ExternalTransactionCategoryCreateDto>
    {
        private readonly IApplicationDbContext _context;

        public ExternalTransactionCategoryCreateDtoValidator(IApplicationDbContext context)
        {
            _context = context;
